...
if path.is_file():
    ...
    sheet1.cell(row= i , column = 6).value = "Out-Time"
    sheet1.cell(row= i , column = 7).value = "Date"
...
while (toClose == False):
    ...
    for row_num in range(sheet.nrows):
        ...
        if row_value[0] == barReader:
            ...
            sheet1.cell(row= i , column = 6).value = NULL
            sheet1.cell(row= i , column = 7).value = today
